...
estrutura_de_pastas:
  criativos: '.agencyos/clientes/{nome}/design/criativos/'
  videos: '.agencyos/clientes/{nome}/design/videos/'
  landing_pages: '.agencyos/clientes/{nome}/design/landing-pages/'
  exports: '.agencyos/clientes/{nome}/design/exports/'

log_ownership:
  arquivo: '.agencyos/clientes/{nome}/operacao/log-performance-criativa.md'
...
pastas_que_acessa:
  - '.agencyos/clientes/{nome}/onboarding/'
  - '.agencyos/clientes/{nome}/estrategia/'
  - '.agencyos/clientes/{nome}/assets/'
  - '.agencyos/clientes/{nome}/branding/'
  - '.agencyos/clientes/{nome}/copy/'
  - '.agencyos/clientes/{nome}/operacao/log-performance-criativa.md'

pastas_que_escreve:
  - '.agencyos/clientes/{nome}/design/'
  - '.agencyos/clientes/{nome}/operacao/log-performance-criativa.md'
...
integracao:
  ...
  estrategista: 'Consulta quando peça requer alinhamento com posicionamento ou narrativa.'
```
