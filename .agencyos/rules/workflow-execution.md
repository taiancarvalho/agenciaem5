...
**Output principal:** `.agencyos/clientes/{nome}/onboarding/briefing.md`
...
**Output:** `.agencyos/clientes/{nome}/setup-tecnico/status.md`
...
**Output principal:** `.agencyos/clientes/{nome}/estrategia/plano-estrategico.md`
...
**Output:** `.agencyos/clientes/{nome}/operacao/log-operacional.md` (sempre atualizado)
...
6. **Nada publicado sem Quality Gate do @qa-campanha**
