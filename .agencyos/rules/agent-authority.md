...
### @agency-master (Atlas) — Orquestração Total
...
1. Agente não consegue completar task → escalar para `@agency-master`
...
4. Conflito de domínio entre agentes → `@agency-master` medeia
