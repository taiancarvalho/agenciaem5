...
inputs:
  - .agencyos/clientes/{nome}/onboarding/briefing-final.md (para saber quais canais serão usados)
outputs:
...
Criar `.agencyos/clientes/{nome}/setup-tecnico/acessos.md`:
...
Criar `.agencyos/clientes/{nome}/setup-tecnico/checklist-tracking.md`:
...
Criar `.agencyos/clientes/{nome}/setup-tecnico/status.md`:
