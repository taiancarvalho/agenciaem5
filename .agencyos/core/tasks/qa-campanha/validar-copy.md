...
inputs:
  - .agencyos/clientes/{nome}/copy/ (arquivos de copy)
...
Identificar todos os arquivos de copy em `.agencyos/clientes/{nome}/copy/` que estao marcados como pendentes de validacao.
