...
Validar que o cliente existe em `.agencyos/clientes/`.
...
Ler `.agencyos/clientes/{nome}/operacao/log-operacional.md` e extrair:
...
1. {acao 1 — ex: @estrategista criar-plano-estrategico}
2. {acao 2}
3. {acao 3}
