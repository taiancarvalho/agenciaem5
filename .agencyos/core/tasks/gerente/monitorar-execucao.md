...
-----------------------|--------------------------------------------
CS onboarding          | .agencyos/clientes/{nome}/onboarding/briefing-final.md
Estrategista           | .agencyos/clientes/{nome}/estrategia/plano-estrategico.md
Gestor (auditoria)     | .agencyos/clientes/{nome}/trafego/ (arquivos de auditoria)
Copywriter             | .agencyos/clientes/{nome}/copy/ (copy por canal)
Designer               | .agencyos/clientes/{nome}/design/criativos/ (arquivos)
QA                     | log-operacional.md com veredicto: APROVADO
Gestor (relatório)     | .agencyos/clientes/{nome}/relatorios/relatorio-{periodo}.md
```
...
→ Acionar: @estrategista *analisar-briefing {cliente}
   Contexto: "Briefing finalizado pelo CS. Leia .agencyos/clientes/{nome}/onboarding/briefing-final.md"
```
