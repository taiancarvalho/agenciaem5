...
## Parte 1 — O que é o OMG.sys

OMG.sys é uma agência de marketing operada por agentes de IA especializados, orquestrados via Claude. Cada agente tem uma função fixa, um conjunto de tasks que sabe executar, e playbooks com o método concreto de como fazer.
...
**3º — `.omgsys/playbooks/traffic-meta.md` (ou google.md)**
