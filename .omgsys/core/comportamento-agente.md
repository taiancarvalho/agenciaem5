# Comportamento Padrão dos Agentes — OMG.sys
...
| Erro de API ou falha de Composio | Escrever em `.omgsys/learnings/ERRORS.md` |
| Cliente corrige o agente | Escrever em `.omgsys/learnings/LEARNINGS.md` |
| Gap identificado no sistema | Escrever em `.omgsys/learnings/FEATURE_REQUESTS.md` |
...
- Erro detectado → Registrar em `.omgsys/learnings/ERRORS.md`
- Aprendizado de negócio → Registrar em `.omgsys/learnings/LEARNINGS.md`
- Gap de capacidade → Registrar em `.omgsys/learnings/FEATURE_REQUESTS.md`
...
**Ação:** Registrar em `.omgsys/learnings/LEARNINGS.md` com category `best_practice`
