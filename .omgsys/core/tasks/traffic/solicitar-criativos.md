...
inputs:
  ...
  - .omgsys/clientes/{nome}/trafego/auditoria.md (se existir)
  - .omgsys/clientes/{nome}/operacao/log-performance-criativa.md (se existir)
outputs:
  - .omgsys/clientes/{nome}/trafego/briefing-criativos.md
elicit: true
---
...
Criar/atualizar `.omgsys/clientes/{nome}/trafego/briefing-criativos.md`:
...
```
Briefing criado em .omgsys/clientes/{nome}/trafego/briefing-criativos.md
