...
inputs:
  ...
  - .omgsys/clientes/{nome}/estrategia/plano-estrategico.md (para comparar com as metas)
outputs:
  - .omgsys/clientes/{nome}/relatorios/{periodo}-relatorio.md
elicit: true
---
...
Criar `.omgsys/clientes/{nome}/relatorios/{periodo}-relatorio.md`:
