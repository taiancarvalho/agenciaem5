...
## Inputs necessários
1. `.omgsys/clientes/{nome}/onboarding/briefing-final.md`
2. `.omgsys/clientes/{nome}/estrategia/plano-estrategico.md`
...
Salvar em: `.omgsys/clientes/{nome}/trafego/keywords-{YYYY-MM-DD}.md`
