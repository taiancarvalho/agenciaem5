...
- Ler `.omgsys/playbooks/traffic-google.md` (seção PMAX) antes de executar
...
## Inputs necessários
1. `.omgsys/clientes/{nome}/onboarding/board-cliente.md` — budget, produto, canal de conversão
2. `.omgsys/clientes/{nome}/estrategia/plano-estrategico.md` — ICP, oferta, KPIs
