...
Gerar documento em `.omgsys/clientes/{nome}/trafego/plano-growth.md`:
...
Para cada acao do plano, adicionar entrada em `.omgsys/clientes/{nome}/operacao/log-growth.md`:
