...
## Inputs necessarios
1. `.omgsys/clientes/{nome}/operacao/log-operacional.md` — ultimas interacoes e status
2. `.omgsys/clientes/{nome}/relatorios/` — relatorio mais recente disponivel
3. `.omgsys/clientes/{nome}/operacao/proximos-passos.md` — pendencias abertas
...
### 3. Gerar pauta
Criar arquivo em: `.omgsys/clientes/{nome}/reunioes/pauta-{YYYY-MM-DD}.md`
...
## Handoff
- Arquivo salvo em `.omgsys/clientes/{nome}/reunioes/`
