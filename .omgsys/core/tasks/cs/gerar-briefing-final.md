...
inputs:
  - .omgsys/clientes/{nome}/onboarding/briefing-respostas.md
outputs:
...
Acessar `.omgsys/clientes/{nome}/onboarding/briefing-respostas.md` e processar todas as respostas.

### 2. Consolidar no template

Gerar o arquivo `.omgsys/clientes/{nome}/onboarding/briefing-final.md` com a estrutura abaixo:
