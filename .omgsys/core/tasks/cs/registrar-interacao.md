...
inputs:
  ...
  - próxima ação
outputs:
  - nova linha em .omgsys/clientes/{nome}/operacao/log-operacional.md
elicit: true
---
...
Abrir `.omgsys/clientes/{nome}/operacao/log-operacional.md` e adicionar ao final:
...
Se a interação gerou ações concretas, atualizar também `.omgsys/clientes/{nome}/operacao/proximos-passos.md`:
