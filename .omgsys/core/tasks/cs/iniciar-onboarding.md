...
outputs:
  - pasta do cliente criada em .omgsys/clientes/{nome}/
...
```bash
node .omgsys/bin/agency-os-new-client.js {nome}
```
...
Criar entrada inicial em `.omgsys/clientes/{nome}/operacao/log-operacional.md`:
...
- Pasta `.omgsys/clientes/{nome}/` criada com estrutura completa
