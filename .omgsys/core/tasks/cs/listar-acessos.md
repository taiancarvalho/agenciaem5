...
Verificar se existe `briefing-final.md` em `.omgsys/clientes/{nome}/onboarding/`. Se existir, extrair os canais que serão utilizados.
...
Criar `.omgsys/clientes/{nome}/setup-tecnico/acessos.md` com o formato abaixo. Incluir **apenas** os canais selecionados.
