...
Ler `acessos.md` em `.omgsys/clientes/{nome}/setup-tecnico/` para saber quais plataformas estao sendo utilizadas e gerar o checklist correspondente.
...
Criar `.omgsys/clientes/{nome}/setup-tecnico/checklist-tracking.md` com o formato abaixo. Incluir apenas as secoes relevantes para os canais do cliente.
