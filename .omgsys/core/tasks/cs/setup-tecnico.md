...
inputs:
  - .omgsys/clientes/{nome}/onboarding/briefing-final.md (para saber quais canais serão usados)
outputs:
  - .omgsys/clientes/{nome}/setup-tecnico/acessos.md
  - .omgsys/clientes/{nome}/setup-tecnico/checklist-tracking.md
...
Criar `.omgsys/clientes/{nome}/setup-tecnico/acessos.md`:
...
Criar `.omgsys/clientes/{nome}/setup-tecnico/checklist-tracking.md`:
...
Criar `.omgsys/clientes/{nome}/setup-tecnico/status.md`:
