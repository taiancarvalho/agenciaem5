...
outputs:
  - .omgsys/clientes/{nome}/copy/conceitos-campanha.md
elicit: true
---
...
Ler `.omgsys/clientes/{nome}/copy/angulos.md` e o plano estratégico.
...
Criar `.omgsys/clientes/{nome}/copy/conceitos-campanha.md`:
