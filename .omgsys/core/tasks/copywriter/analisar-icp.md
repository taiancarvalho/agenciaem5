...
inputs:
  ...
  - .omgsys/clientes/{nome}/estrategia/plano-estrategico.md (se existir)
outputs:
...
Ler `.omgsys/clientes/{nome}/onboarding/briefing-final.md` inteiro. Se plano estrategico existir, ler tambem para confirmar ou ajustar a interpretacao.

### 2. Extrair perfis de copy

Criar `.omgsys/clientes/{nome}/copy/analise-icp.md`:
