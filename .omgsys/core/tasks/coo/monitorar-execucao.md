...
-----------------------|--------------------------------------------
CS onboarding          | .omgsys/clientes/{nome}/onboarding/briefing-final.md
Estrategista           | .omgsys/clientes/{nome}/estrategia/plano-estrategico.md
Gestor (auditoria)     | .omgsys/clientes/{nome}/trafego/ (arquivos de auditoria)
Copywriter             | .omgsys/clientes/{nome}/copy/ (copy por canal)
Designer               | .omgsys/clientes/{nome}/design/criativos/ (arquivos)
QA                     | log-operacional.md com veredicto: APROVADO
Gestor (relatório)     | .omgsys/clientes/{nome}/relatorios/relatorio-{periodo}.md
```
...
→ Acionar: @strategist *analisar-briefing {cliente}
   Contexto: "Briefing finalizado pelo CS. Leia .omgsys/clientes/{nome}/onboarding/briefing-final.md"
```
