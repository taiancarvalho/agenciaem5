...
Ler o arquivo do workflow em `.omgsys/core/workflows/{nome}.yaml`.

### 2. Verificar estado do cliente

Checar em `.omgsys/clientes/{nome}/operacao/` o que já foi feito:
...
Arquivo de referência: .omgsys/clientes/{nome}/{caminho}
