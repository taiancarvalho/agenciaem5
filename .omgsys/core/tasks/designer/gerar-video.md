...
inputs:
  ...
  - .omgsys/clientes/{nome}/branding/ (identidade visual)
  - .omgsys/clientes/{nome}/design/conceito-visual-CR-{id}.md (conceito definido)
outputs:
  - .omgsys/clientes/{nome}/design/videos/CR-{id}-v1.mp4
  - JSON de prompt em .omgsys/clientes/{nome}/design/videos/prompts/CR-{id}-prompt.json
elicit: true
---
...
- **Copy**: `.omgsys/clientes/{nome}/copy/CR-{id}.md` — extrair hook, angulo, promessa e CTA
- **Branding**: `.omgsys/clientes/{nome}/branding/` — cores, fontes, guia de estilo
- **Conceito visual**: documento gerado pela task `definir-conceito-visual`
- **Assets**: `.omgsys/clientes/{nome}/assets/` — elementos disponiveis para usar
...
- Salvar o JSON do prompt em `.omgsys/clientes/{nome}/design/videos/prompts/CR-{id}-prompt.json`

### 6. Versionar e salvar

Salvar video em `.omgsys/clientes/{nome}/design/videos/`:
...
Salvar prompt JSON em `.omgsys/clientes/{nome}/design/videos/prompts/`:
