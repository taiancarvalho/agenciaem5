...
inputs:
  - .omgsys/clientes/{nome}/operacao/log-performance-criativa.md (dados de performance)
  - .omgsys/clientes/{nome}/design/criativos/ ou /videos/ (criativo original)
...
Ler `.omgsys/clientes/{nome}/operacao/log-performance-criativa.md` e localizar o CR-{id}:
...
```
Imagem:  .omgsys/clientes/{nome}/design/criativos/CR-{id}-v{n+1}.png
Video:   .omgsys/clientes/{nome}/design/videos/CR-{id}-v{n+1}.mp4
Prompts: .omgsys/clientes/{nome}/design/criativos/prompts/CR-{id}-v{n+1}-prompt.json
```

### 7. Atualizar o log

Em `.omgsys/clientes/{nome}/operacao/log-performance-criativa.md`, na entrada do CR-{id}:
