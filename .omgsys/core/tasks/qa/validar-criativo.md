...
inputs:
  - .omgsys/clientes/{nome}/design/ (arquivos de criativo)
  - .omgsys/clientes/{nome}/branding/ (cores.yaml, fontes.yaml, guia-estilo.md)
  - .omgsys/clientes/{nome}/copy/ (copy associada ao criativo)
outputs:
...
Identificar os arquivos de criativo em `.omgsys/clientes/{nome}/design/` pendentes de validacao.

### 2. Ler diretrizes de branding

Consultar `.omgsys/clientes/{nome}/branding/cores.yaml`, `fontes.yaml` e `guia-estilo.md` (se existir) para validar conformidade visual.
