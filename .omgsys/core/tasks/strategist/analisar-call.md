...
outputs:
  - .omgsys/clientes/agencia/vendas/analise-call-{id}.md
  - atualização em .omgsys/clientes/agencia/vendas/script-vendas.md (se aplicável)
elicit: true
---
...
`.omgsys/clientes/agencia/vendas/script-vendas.md`
...
Registrar em `.omgsys/clientes/agencia/vendas/objecoes.md`:
