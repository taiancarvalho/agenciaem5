...
## Inputs necessarios
1. `.omgsys/clientes/{nome}/onboarding/briefing-final.md` — lista de concorrentes mencionados
...
### 4. Gerar documento
Salvar em: `.omgsys/clientes/{nome}/estrategia/analise-concorrentes.md`
