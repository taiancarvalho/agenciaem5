...
**Output principal:** `.omgsys/clientes/{nome}/onboarding/briefing.md`
...
**Output:** `.omgsys/clientes/{nome}/setup-tecnico/status.md`
...
**Output principal:** `.omgsys/clientes/{nome}/estrategia/plano-estrategico.md`
...
**Output:** `.omgsys/clientes/{nome}/operacao/log-operacional.md` (sempre atualizado)
