...
name: analisar-call
agent: estrategista
description: "Analisar transcri\xE7\xE3o ou resumo de call de vendas para extrair\
  \ obje\xE7\xF5es, padr\xF5es e melhorias para o script comercial"
inputs:
- "transcri\xE7\xE3o ou resumo da call (colado pelo usu\xE1rio)"
- "resultado da call (fechou / n\xE3o fechou / em follow-up)"
outputs:
- .agencyos/clientes/agencia/vendas/analise-call-{id}.md
- "atualiza\xE7\xE3o em .agencyos/clientes/agencia/vendas/script-vendas.md (se aplic\xE1\
  vel)"
elicit: true
metadata:
  openclaw:
