...
agent: copywriter
description: "Definir conceitos de campanha \u2014 headline, promessa e dire\xE7\xE3\
  o principal da pe\xE7a \u2014 combinando \xE2ngulo com execu\xE7\xE3o visual"
inputs:
- .agencyos/clientes/{nome}/copy/angulos.md
- .agencyos/clientes/{nome}/estrategia/plano-estrategico.md
outputs:
- .agencyos/clientes/{nome}/copy/conceitos-campanha.md
elicit: true
metadata:
  openclaw:
    emoji: "\U0001F9E0"
...
Ler `.agencyos/clientes/{nome}/copy/angulos.md` e o plano estratégico.
...
Criar `.agencyos/clientes/{nome}/copy/conceitos-campanha.md`:
