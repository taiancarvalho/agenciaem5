...
agent: cs
description: Consolidar as respostas do briefing em um documento estruturado e validado
...
Acessar `.agencyos/clientes/{nome}/onboarding/briefing-respostas.md` e processar todas as respostas.

### 2. Consolidar no template

Gerar o arquivo `.agencyos/clientes/{nome}/onboarding/briefing-final.md` com a estrutura abaixo:
...
- Pronto para: `@estrategista *analisar-briefing {nome}`
