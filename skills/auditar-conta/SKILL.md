...
description: "Auditar a conta de an\xFAncios do cliente para mapear o hist\xF3rico,\
  \ campanhas ativas, padr\xF5es de performance e oportunidades antes de agir"
inputs:
- .agencyos/clientes/{nome}/onboarding/briefing-final.md
- .agencyos/clientes/{nome}/estrategia/plano-estrategico.md
- "acesso \xE0 conta de an\xFAncios (Meta Ads ou Google Ads)"
outputs:
