...
agent: designer
description: Registrar novo criativo no log de performance criativa com metadados
  visuais e referencias
inputs:
...
Abrir `.agencyos/clientes/{nome}/operacao/log-performance-criativa.md` e adicionar nova linha:
