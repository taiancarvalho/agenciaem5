...
agent: cs
description: Gerar checklist manual de validacao de pixel, eventos, GA4 e conversoes
  para o setup tecnico
inputs:
- nome do cliente (workspace ja criado)
- canais selecionados (do briefing-final.md ou da lista de acessos)
outputs:
- .agencyos/clientes/{nome}/setup-tecnico/checklist-tracking.md
...
Ler `acessos.md` em `.agencyos/clientes/{nome}/setup-tecnico/` para saber quais plataformas estao sendo utilizadas e gerar o checklist correspondente.
...
Criar `.agencyos/clientes/{nome}/setup-tecnico/checklist-tracking.md` com o formato abaixo. Incluir apenas as secoes relevantes para os canais do cliente.
