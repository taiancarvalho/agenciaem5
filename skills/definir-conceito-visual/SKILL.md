...
agent: designer
description: Escolher conceito visual antes de produzir criativos, com base na copy,
  estrategia e branding do cliente
inputs:
- .agencyos/clientes/{nome}/copy/CR-{id}.md (copy da campanha)
- .agencyos/clientes/{nome}/estrategia/ (documento de estrategia)
- .agencyos/clientes/{nome}/branding/ (cores, fontes, guia de estilo)
outputs:
- conceito visual definido e documentado em .agencyos/clientes/{nome}/operacao/log-performance-criativa.md
...
Acessar `.agencyos/clientes/{nome}/copy/CR-{id}.md` e extrair:
...
Acessar `.agencyos/clientes/{nome}/estrategia/` e extrair:
...
- `.agencyos/clientes/{nome}/branding/cores.yaml` — paleta de cores
- `.agencyos/clientes/{nome}/branding/fontes.yaml` — tipografia
- `.agencyos/clientes/{nome}/branding/guia-estilo.md` — tom visual, restrições
- `.agencyos/clientes/{nome}/assets/` — logo, fotos, produtos disponíveis
...
Encontrar a linha do `CR-{id}` em `.agencyos/clientes/{nome}/operacao/log-performance-criativa.md` e registrar:
