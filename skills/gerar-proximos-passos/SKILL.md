...
agent: cs
description: Gerar resumo de proximos passos e pendencias do cliente apos reuniao
  ou interacao
inputs:
- nome do cliente
...
- .agencyos/clientes/{nome}/operacao/proximos-passos.md
elicit: true
metadata:
  openclaw:
    emoji: "\U0001F9E0"
...
Ler o `log-operacional.md` em `.agencyos/clientes/{nome}/operacao/` para entender:
...
Criar `.agencyos/clientes/{nome}/operacao/proximos-passos.md`:
