...
name: adaptar-canal
agent: copywriter
description: Transformar copy existente no formato correto para cada canal (Meta,
  WhatsApp, e-mail, LinkedIn, blog)
inputs:
- .agencyos/clientes/{nome}/copy/ (peca original)
- .agencyos/clientes/{nome}/estrategia/plano-estrategico.md
outputs:
- .agencyos/clientes/{nome}/copy/CR-{NNN}-adaptada-{canal}.md
elicit: false
metadata:
  openclaw:
    emoji: "\U0001F9E0"
...
Criar `.agencyos/clientes/{nome}/copy/CR-{NNN}-adaptada-{canal}.md`:
