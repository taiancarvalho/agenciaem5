...
agent: estrategista
description: "Formular hipoteses de campanha antes da execucao \u2014 o que acreditamos\
  \ que funciona e por que"
inputs:
- .agencyos/clientes/{nome}/estrategia/plano-estrategico.md (ou secao de funil)
