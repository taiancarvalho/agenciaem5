...
agent: cs
description: "Montar e enviar relat\xF3rio de performance ao cliente \u2014 nunca\
  \ pelo Gestor de Tr\xE1fego diretamente"
inputs:
- ".agencyos/clientes/{nome}/relatorios/{mes}-relatorio.md (gerado pelo Gestor de\
  \ Tr\xE1fego)"
...
Acessar `.agencyos/clientes/{nome}/relatorios/` e ler o relatório mais recente gerado pelo Max.
