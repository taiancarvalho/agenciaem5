...
description: "Ativar modo de escala \u2014 identificar vencedores, propor estrategias\
  \ verticais/horizontais e registrar acoes de growth"
inputs:
...
Gerar documento em `.agencyos/clientes/{nome}/trafego/plano-growth.md`:
...
Para cada acao do plano, adicionar entrada em `.agencyos/clientes/{nome}/operacao/log-growth.md`:
