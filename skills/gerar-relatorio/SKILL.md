...
description: "Gerar relat\xF3rio t\xE9cnico de performance do per\xEDodo para o CS\
  \ entregar ao cliente"
inputs:
- "dados de performance do per\xEDodo (m\xEAs ou semana)"
- .agencyos/clientes/{nome}/operacao/log-performance-criativa.md
- .agencyos/clientes/{nome}/estrategia/plano-estrategico.md (para comparar com as
  metas)
outputs:
- .agencyos/clientes/{nome}/relatorios/{periodo}-relatorio.md
elicit: true
metadata:
  openclaw:
    emoji: "\U0001F9E0"
...
Criar `.agencyos/clientes/{nome}/relatorios/{periodo}-relatorio.md`:
