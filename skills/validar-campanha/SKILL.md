...
agent: qa-campanha
description: "Executar checklist completo de valida\xE7\xE3o antes de subir qualquer\
  \ campanha ao ar"
inputs:
- .agencyos/clientes/{nome}/estrategia/plano-estrategico.md
- .agencyos/clientes/{nome}/copy/ (copies aprovadas)
- .agencyos/clientes/{nome}/design/ (criativos aprovados)
- .agencyos/clientes/{nome}/setup-tecnico/status.md
- "estrutura de campanha descrita pelo Gestor de Tr\xE1fego"
outputs:
- veredicto formal: "APROVADO / REVIS\xC3O / BLOQUEADO"
