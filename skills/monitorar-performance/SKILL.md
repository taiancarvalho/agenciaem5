...
description: Monitorar diariamente as campanhas para detectar e evitar desvios graves
  de performance e desperdicio de verba
inputs:
- .agencyos/clientes/{nome}/trafego/campanhas-ativas.md
- acesso a conta de anuncios
- .agencyos/clientes/{nome}/estrategia/plano-estrategico.md (KPIs de referencia)
outputs:
