...
description: "Gerar briefing claro de criativos para o Copywriter e o Designer produzirem\
  \ \u2014 com contexto de performance e objetivo da pe\xE7a"
inputs:
- .agencyos/clientes/{nome}/estrategia/plano-estrategico.md
- .agencyos/clientes/{nome}/trafego/auditoria.md (se existir)
- .agencyos/clientes/{nome}/operacao/log-performance-criativa.md (se existir)
outputs:
- .agencyos/clientes/{nome}/trafego/briefing-criativos.md
elicit: true
metadata:
  openclaw:
    emoji: "\U0001F9E0"
...
Criar/atualizar `.agencyos/clientes/{nome}/trafego/briefing-criativos.md`:
...
```
Briefing criado em .agencyos/clientes/{nome}/trafego/briefing-criativos.md
