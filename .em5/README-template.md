...
agenciaem5 e um conjunto de **agentes especializados**, ** tasks executaveis**, **templates**, **workflows** e **checklists** que transformam a operacao de marketing em processo padronizado e replicavel.
...
Ou copie `.em5/` para seu projeto manualmente.
...
```bash
node .em5/bin/agency-os-new-client.js nome-do-cliente
```
