...
Contar tasks por agente em `.em5/agents/`:
...
Checar diretorios em `.em5/system/templates/`:
...
[ ] .em5/system/rules/agent-authority.md
[ ] .em5/system/rules/agent-handoff.md
[ ] .em5/system/rules/workflow-execution.md
[ ] .claude/CLAUDE.md
```
