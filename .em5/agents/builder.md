...
agent:
  ...
  icon: 🔨
  whenToUse: Use quando @arq Arq entrega spec aprovada. Cunha cria agente/task/playbook/skill via .em5/setup/forge-templates/ e atualiza configs centrais (CLAUDE.md, AGENTS.md, em5-config.yaml).
