...
outputs:
  ...
  - auditoria em .em5/system/learnings/{ano-mes}/qa-* quando aplicável
elicit: true
model_tier: frontier  # validação final = Opus sempre
gate_matrix: .em5/system/data/gate-matrix.yaml
---
...
Carrega `.em5/system/data/gate-matrix.yaml` pra classificar cada issue:
...
| **APROVADO_COM_RESSALVA** ⚠️ | Só issues `baixo` | Publica + log em `.em5/system/learnings/{ano-mes}/qa-overrides.md` |
