...
Antes de prometer auto-transcrição: rodar `node .em5/infra/infrastructure/index.js toolsets` e checar se `whisper` está disponível no Composio. Se não, documenta limitação.
