...
elicit: true
model_tier: balanced
tool_dependency: .em5/infra/tools/design-extractor/
mcp_toolsets:
...
- `.em5/infra/tools/design-extractor/` disponível (Fase 13.1)
...
Carrega `.em5/infra/tools/design-extractor/SKILL-source.md` (89 linhas — fonte da verdade).
Aplica regras:
...
- Templates obrigatórios `.em5/infra/tools/design-extractor/templates/design-board-preview.{html,css,js}`
