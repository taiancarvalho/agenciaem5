...
2. `.em5/system/templates/contratos/proposta-base.md` — template de proposta
3. `em5-config.yaml` — servicos e valores da agencia (se configurado)
...
### 3. Gerar proposta
Criar arquivo em: `.em5/prospects/{nome}/proposta-{YYYY-MM-DD}.md`
...
- Criar pasta `.em5/prospects/{nome}/` se nao existir
- Salvar proposta
