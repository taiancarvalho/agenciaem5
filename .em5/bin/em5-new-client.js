...
// Uso: node .em5/bin/em5-new-client.js {nome-do-cliente}
...
if (!projectName) {
  console.error('Uso: node .em5/bin/em5-new-client.js {nome-do-cliente}');
  console.error('Exemplo: node .em5/bin/em5-new-client.js clinica-sao-paulo');
  process.exit(1);
}
...
if (!fs.existsSync(path.join(rootDir, '.em5'))) {
  ...
  console.error('Execute primeiro: node .em5/bin/em5-init.js');
  process.exit(1);
}
