...
// Uso: node .em5/bin/em5-validate.js [--fix]
...
const infra = require(path.join(ROOT, '.em5/infrastructure/index.js'));
...
check('Estrutura learnings inicializada', 'MUST', () => {
  if (!infra.learnings.available) return '.em5/learnings/_template.md ausente';
