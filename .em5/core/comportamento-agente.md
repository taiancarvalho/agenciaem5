...
| Erro de API ou falha de Composio | Escrever em `.em5/learnings/ERRORS.md` |
| Cliente corrige o agente | Escrever em `.em5/learnings/LEARNINGS.md` |
| Gap identificado no sistema | Escrever em `.em5/learnings/FEATURE_REQUESTS.md` |
...
- Erro detectado → Registrar em `.em5/learnings/ERRORS.md`
- Aprendizado de negócio → Registrar em `.em5/learnings/LEARNINGS.md`
- Gap de capacidade → Registrar em `.em5/learnings/FEATURE_REQUESTS.md`
...
**Ação:** Registrar em `.em5/learnings/LEARNINGS.md` com category `best_practice`
