...
inputs:
  ...
  - arquivos criados
outputs:
  - .em5/construcao/{ticket}/review.md (com gaps + sugestões)
elicit: false
model_tier: frontier
---
...
2. Pra cada gap, gera sugestão concreta:
   ...
   - **Sugestão:** "Em `.em5/agents/{id}.md` linha {N}, adicionar 2 itens. Sugestões baseadas no domínio: 1) NÃO X 2) NÃO Y"
...
3. Estrutura no `review.md`:
   ...
   - **Arquivo:** .em5/core/tasks/{x}/{y}.md frontmatter
