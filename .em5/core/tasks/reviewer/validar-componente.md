...
Executa `node .em5/bin/em5-validate.js`. Se exit ≠ 0 → componente quebrou conformidade global → BLOQUEADO.
...
Componente novo duplica algo existente? Busca em `.em5/agents/`, `.em5/core/tasks/`, `.em5/playbooks/`. Se sim → BLOQUEADO + sugere composição.
