...
outputs:
  - .em5/construcao/{ticket}/entrevista.md (transcrição + decisões)
elicit: true
model_tier: frontier
---
...
Formato: `CT-{NNN}` (Construção, sequencial). Ler `.em5/construcao/` pra próximo ID.
...
- entrevista.md salvo em `.em5/construcao/{ticket}/`
