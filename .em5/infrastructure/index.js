...
const infrastructure = {
  ...
  // Forge — Fase 2
  forge: {
    available: fileExists('.em5/bin/em5-forge.js'),
    bin: path.join(ROOT, '.em5/bin/em5-forge.js'),
    templates: path.join(ROOT, '.em5/setup/forge-templates'),
  },

  // Gate-Matrix — Fase 3
  gateMatrix: {
    available: fileExists('.em5/core/data/gate-matrix.yaml'),
    config: path.join(ROOT, '.em5/core/data/gate-matrix.yaml'),
    load() {
      return loadYAML('.em5/core/data/gate-matrix.yaml');
    },
  },

  // Learnings — Fase 1.2
  learnings: {
    available: fileExists('.em5/learnings/_template.md'),
  ...
  constitution: {
    available: fileExists('.em5/core/constitution.md'),
    path: path.join(ROOT, '.em5/core/constitution.md'),
    extractArticles() {
      if (!this.available) return [];
...
// CLI: node .em5/infrastructure/index.js [health|toolsets|agents|articles]
