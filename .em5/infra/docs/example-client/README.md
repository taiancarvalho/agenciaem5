...
Movido pra `.em5/infra/docs/` pra ser **invisível ao sistema** mas visível pra docs.
...
```bash
tree .em5/infra/docs/example-client/
# ou
find .em5/infra/docs/example-client -type f -name '*.md' | head -20
```
...
Após operar com 1 cliente real bem-sucedido, anonimize e mova pra `.em5/infra/docs/example-client-{slug}/`.
