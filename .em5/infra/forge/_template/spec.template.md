...
Categoria a inicializar em `.em5/system/learnings/{ano-mes}/`:
...
- `.em5/agents/{slug}/persona.md` (novo)
- `.em5/agents/{slug}/` (novo dir)
- `.claude/commands/{skill}.md` (novo)
- `.em5/agents/{slug}/playbook.md` (novo, se aplicável)
- `.em5/system/data/{data}.yaml` (novo, se aplicável)
- `.claude/CLAUDE.md` (atualizar tabela agentes + skills)
- `.em5/system/AGENTS.md` (atualizar tabela)
