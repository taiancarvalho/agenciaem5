...
// em5-new-client.js
// Cria workspace de novo cliente no em5
// Uso: node .em5/infra/bin/em5-new-client.js {nome-do-cliente}
...
if (!projectName) {
  console.error('Uso: node .em5/infra/bin/em5-new-client.js {nome-do-cliente}');
  console.error('Exemplo: node .em5/infra/bin/em5-new-client.js clinica-sao-paulo');
  process.exit(1);
}
...
const clientesDir = path.join(rootDir, '.em5', 'clientes');

// Verificar se pasta em5 existe
if (!fs.existsSync(path.join(rootDir, '.em5'))) {
  console.error('❌ em5 nao encontrado neste projeto.');
  console.error('Execute primeiro: node .em5/infra/bin/em5-init.js');
  process.exit(1);
}
