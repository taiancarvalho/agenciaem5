...
// Uso: node .em5/infra/bin/em5-forge.js [tipo]
...
async function forgeAgent() {
  ...
  console.log(`   2. Adicione em .em5/system/AGENTS.md`);
...
async function forgeTask() {
  ...
  fs.writeFileSync(outPath, out);
  console.log(`\n✓ Criado: ${outPath}`);
  console.log(`📋 Lembre de adicionar a task em .em5/agents/${agentId}/persona.md → commands list`);
}
