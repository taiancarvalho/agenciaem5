...
// Uso: node .em5/infra/bin/em5-import-gpt.js <caminho>
// Formatos suportados:
...
function generateDataFiles(extracted, mapping) {
  const dataDir = path.join(ROOT, '.em5/system/data', mapping.slug);
...
async function main() {
  ...
  console.log(`✓ ${dataFiles.length} data files em .em5/system/data/${mapping.slug}/`);

  console.log('\n📋 Próximos passos manuais:');
  console.log('  1. Revise .em5/agents/' + mapping.slug + '/persona.md');
  console.log('  2. Crie tasks específicas em .em5/agents/' + mapping.slug + '/');
