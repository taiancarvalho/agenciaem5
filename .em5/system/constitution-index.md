...
| IX | Composio como Gateway Externo | NON-NEGOTIABLE | Único gateway de integração — exceções em `.em5/infra/integracoes/excecoes.yaml` |
| X | Learnings Perpétuos | MUST | Decisões importantes viram entry em `.em5/system/learnings/` |
