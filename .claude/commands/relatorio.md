...
- `.omgsys/clientes/{nome}/operacao/log-operacional.md` — período e últimas campanhas
- `.omgsys/clientes/{nome}/trafego/` — dados de campanha disponíveis

Acione @traffic com:
- Cliente: {nome}
- Objetivo: gerar relatório de performance do período
- Referência: dados em `.omgsys/clientes/{nome}/trafego/`
- Destino: `.omgsys/clientes/{nome}/relatorios/relatorio-{YYYY-MM-DD}.md`
