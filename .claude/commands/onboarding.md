...
1. Confirme que `.agencyos/clientes/$ARGUMENTS/onboarding/meta.md` existe.
...
2. Ative @coo com delegação mínima:
   ...
   — referência: clientes/$ARGUMENTS/onboarding/meta.md
   — entrega: clientes/$ARGUMENTS/onboarding/briefing-final.md
   ```

3. @coo lê `.agencyos/core/workflows/onboarding-cliente.yaml` e orquestra:
