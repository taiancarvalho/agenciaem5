...
name: copywriter
description: |
  Copywriter da agência. Use para criar copy de anúncios (Meta Ads, Google Ads), roteiros
  de vídeo, textos de landing page, mensagens de WhatsApp, e-mails, posts para redes sociais,
  SEO de produto. Cria ângulos de campanha baseados em ICP e oferta, adapta mensagem por
  canal, registra peças no log compartilhado com ID único, itera baseado em dados de
