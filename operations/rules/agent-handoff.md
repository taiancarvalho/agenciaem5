...
Prevenir acúmulo de contexto ao trocar entre agentes do AgencyOS.
...
handoff:
  ...
  cliente_context:
    ...
    cliente_path: ".agencyos/clientes/{nome}/"
...
```
@cs cria onboarding → @estrategista analisa briefing
...
- Artefato handoff (~400 tokens) → RETIDO
  ...
  - artifacts_generated: [".agencyos/clientes/clinica-sp/onboarding/briefing.md"]
  - next_action: "analisar briefing e gerar plano estratégico"
- Persona @estrategista (~3K tokens) → CARREGADA
